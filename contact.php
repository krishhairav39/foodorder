                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(img/contact.jpg)">
                          <div class="detail-box p-4">
                            <h1 class="text-white font-weight-light mb-3">ADDRESS</h1>
                             <h3>Agola Road Hanuman Tekri Palanpur-385001</Palanpur-385001></h3>
                             <br>
                            <h1 class="text-white font-weight-light mb-3 mt-4">CALL US</h1>
                            <h3>+91-7046464885</h3>
